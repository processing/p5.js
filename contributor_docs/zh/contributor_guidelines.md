...
如果要求对你的拉取请求进行修改，并且你能够进行这些修改，请按照[之前相同的流程](#git-workflow)继续使用你本地的仓库副本和相关分支，进行修改、提交到 Git，并将它们推送到你 fork 的远程仓库。一旦你将额外的提交推送到 fork 的远程仓库，
