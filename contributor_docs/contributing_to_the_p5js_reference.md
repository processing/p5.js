...
- See the [Web Accessibility Contributor Document](./web_accessibility.md#user-generated-accessible-canvas-descriptions) for the structure of p5.js’ web accessibility features for contributors.
