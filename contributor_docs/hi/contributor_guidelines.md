...
- [सभी समस्याओं के बारे में](#समस्याएँ-के-बारे-में-सब-कुछ)
  - [समस्याएँ क्या हैं?](#समस्याएँ-क्या-हैं?)
  - [समस्या टेम्पलेट](#समस्या-टेम्पलेट)
    - [कोई बग मिला](#बग-मिला)
    - [मौजूदा सुविधा में सुधार](#मौजूदा-सुविधा-में-सुधार)
    - [नई सुविधा का अनुरोध](#नई-सुविधा-का-अनुरोध)
    - [चर्चा](#चर्चा)
- [p5.js कोडबेस पर काम कर रहे हैं](#p5.js-कोडबेस-पर-काम-कर-रहे-हैं)
  - [डेवलपर्स के लिए त्वरित शुरुआत](#डेवलपर्स-के-लिए-त्वरित-शुरुआत)
  - [गिटहब संपादन कार्यक्षमता का उपयोग](#गिटहब-संपादन-कार्यक्षमता-का-उपयोग)
  - [p5.js को फॉर्क करें और अपने फॉर्क से काम करें](#p5.js-को-फॉर्क-करें-और-अपने-फॉर्क-से-काम-करें)
    - [गिटहब डेस्कटॉप का उपयोग](#गिटहब-डेस्कटॉप-का-उपयोग)
    - [गिट कमांड लाइन इंटरफ़ेस का उपयोग](#गिट-कमांड-लाइन-इंटरफ़ेस-का-उपयोग)
  - [कोडबेस विश्लेषण](#कोडबेस-विश्लेषण)
  - [निर्माण सेटअप](#निर्माण-सेटअप)
  - [गिट वर्कफ़्लो](#गिट-वर्कफ़्लो)
    - [सोर्स कोड](#सोर्स-कोड)
    - [यूनिट टेस्ट](#यूनिट-टेस्ट)
    - [इनलाइन दस्तावेज़ीकरण](#इनलाइन-दस्तावेज़ीकरण)
    - [अंतरराष्ट्रीयकरण](#अंतरराष्ट्रीयकरण)
    - [पहुँचनीयता](#पहुँचनीयता)
  - [कोड मानक](#कोड-मानक)
...
![p5.js लाइब्रेरी गिटहब रिपॉजिटरी का एक क्रॉप्ड स्क्रीनशॉट, केवल ऊपरी दाएं कोने की सामग्री दिखा रहा है। स्क्रीनशॉट के शीर्ष पर मुद्दे टैब के आसपास एक लाल बॉक्स बनाया गया है।](../images/issues-tab.png)

"समस्या" गिटहब पर एक पोस्ट के लिए एक सामान्य नाम है जो किसी समस्या को वर्णित करने का उद्देश्य रखता है। यह समस्या एक त्रुटि रिपोर्ट, नई फीचर जोड़ने का अनुरोध, एक चर्चा, या p5.js पुस्तकालय विकास से संबंधित किसी भी पोस्ट के रूप में काम कर सकती है। प्रत्येक समस्या के नीचे किसी भी गिटहब खाते वाले व्यक्ति, सहित बॉट्स, द्वारा टिप्पणियाँ जोड़ी जा सकती हैं! यह वह स्थान है जहां योगदानकर्ताओं ने परियोजना के विकास से संबंधित विषयों पर चर्चा करते हैं।

जबकि एक समस्या कई विभिन्न कारणों के लिए खोली जा सकती है, हम आमतौर पर केवल p5.js स्रोत कोड के विकास पर चर्चा करने के लिए समस्याएँ का उपयोग करते हैं। अपने कोड की डीत्रुटििंग, अपने परियोजना में सहयोगी निमंत्रण करने, या अन्य असंबंधित विषयों जैसे विषयों पर हम केवल [फोरम](https://discourse.processing.com) या अन्य प्लेटफ़ॉर्मों जैसे [डिस्कोर्ड](https://discord.gg/SHQ8dH25r9) पर चर्चा करते हैं।
...
![गिटहब पर एक मामले की जैसे दिखने वाली एक उदाहरण स्क्रीनशॉट। स्क्रीनशॉट में मुद्दे का शीर्षक "सफारी में चेतावनी लॉग हो रही है जब 2डी मोड में फ़िल्टर शेडर का उपयोग किया जाता है #6597" है।](../images/github-issue.png)
...
जब आप p5.js में संभावित गलत व्यवहार का सामना करते हैं या दस्तावेज़ में वर्णित अनुसार व्यवहार नहीं करते हैं, तो [इस टेम्पलेट](https://github.com/processing/p5.js/issues/new?assignees=\&labels=Bug\&projects=\&template=found-a-bug.yml). कृपया ध्यान दें कि यदि आप अपने स्केच को डीत्रुटि करने का प्रयास कर रहे हैं और आपको लगता है कि यह आपके कोड में कोई समस्या हो सकती है, तो आपको पहले [डिस्कोर्स फोरम](https://discourse.processing.org) पर पूछना चाहिए।
...
4. *ऑपरेटिंग सिस्टम* - यदि संभव हो तो आपको ओएस संस्करण संख्या शामिल करनी चाहिए, उदाहरण के लिए, `macOS 12.5`। कुछ त्रुटि OS व्यवहार से उत्पन्न हो सकते हैं।
5. *इसे पुन: प्रस्तुत करने के चरण* - यह संभवतः साझा करने के लिए सबसे महत्वपूर्ण जानकारी है। आप जो त्रुटि देख रहे हैं उसकी प्रतिकृति बनाने के लिए आपको विस्तृत चरणों की सूची बनानी चाहिए। एक बुनियादी नमूना कोड साझा करना जो समस्या को प्रदर्शित करता है, उस व्यक्ति के लिए बहुत मददगार साबित हो सकता है जो उस त्रुटि को दोहराना चाहता है जिसका आप सामना कर रहे हैं और समाधान तैयार करना शुरू कर सकते हैं।

**प्रतिकृति कुंजी है!** इस टेम्पलेट में कई फ़ील्ड का उद्देश्य त्रुटि की प्रतिलिपि बनाना है। जितनी अधिक जानकारी आप हमें अपने स्केच के परिवेश के बारे में प्रदान कर सकते हैं और जो आप देख रहे हैं उसे दूसरे कैसे दोहरा सकते हैं, किसी के लिए भी आपकी समस्या को समझना और समाधान खोजना शुरू करना उतना ही आसान होगा।
...
गिटहब वेब इंटरफ़ेस पर किसी फ़ाइल को देखते समय, आप जिस फ़ाइल को देख रहे हैं उसकी सामग्री के शीर्ष के पास एक पेंसिल आइकन बटन होगा। यह बटन गिटहब द्वारा प्रदान की गई एक सुविधाजनक संपादन सुविधा है जो उन कई प्रक्रियाओं को सरल बनाती है जिन्हें हम नीचे कवर करेंगे और इसका उपयोग आपके द्वारा देखी जा रही फ़ाइल में त्वरित और सरल संपादन करने के लिए किया जा सकता है।
...
- **पहुंच** हम सबसे पहले पहुंच को प्राथमिकता देते हैं, और हमारे द्वारा लिए गए निर्णयों में इस बात को ध्यान में रखना चाहिए कि यह ऐतिहासिक रूप से हाशिए पर रहने वाले समूहों तक पहुंच कैसे बढ़ाता है। हमारे पहुंच विवरण में इसके बारे में और पढ़ें।
...
- **शैक्षिक** p5.js एक एपीआई और पाठ्यक्रम पर केंद्रित है जो शैक्षिक उपयोग का समर्थन करता है, जिसमें सहायक उदाहरणों के साथ एपीआई का पूरा संदर्भ, साथ ही शिक्षक और नमूना कक्षा पाठ्यक्रम शामिल हैं जो मुख्य रचनात्मक कोडिंग सिद्धांतों को स्पष्ट रूप से पेश करते हैं।
