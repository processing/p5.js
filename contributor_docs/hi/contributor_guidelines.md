...
- [पुल रिक्वेस्ट](#पुल-रिक्वेस्ट)
  - [पुल रिक्वेस्ट बनाना](#पुल-रिक्वेस्ट-बनाना)
    ...
    - [रिबेस और रेसोल्वे कनफ्लिक्ट](#रिबेस-और-रेसोल्वे-कनफ्लिक्ट)
...
जब आप p5.js में संभावित गलत व्यवहार का सामना करते हैं या दस्तावेज़ में वर्णित अनुसार व्यवहार नहीं करते हैं, तो [इस खाका](https://github.com/processing/p5.js/issues/new?assignees=\&labels=Bug\&projects=\&template=found-a-bug.yml). कृपया ध्यान दें कि यदि आप अपने स्केच को डीत्रुटि करने का प्रयास कर रहे हैं और आपको लगता है कि यह आपके कोड में कोई समस्या हो सकती है, तो आपको पहले [डिस्कोर्स फोरम](https://discourse.processing.org) पर पूछना चाहिए।
