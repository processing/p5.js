 ...
 */
  ...
  /**
 * Get a random 2D unit vector and set its components.
 * When applied to a vector generated by <a href = "#/p5/createVector">createVector()</a>,
 * the p5.js function <a href = "#/p5/random">random()</a> is used, so the result
 * will be affected by <a href = "#/p5/randomSeed">randomSeed()</a>.
 *
 * @method setRandom2D
 * @chainable
 *
 ...
 */
  ...
  /**
 * Get a random 3D unit vector and set its components.
 * When applied to a vector generated by <a href = "#/p5/createVector">createVector()</a>,
 * the p5.js function <a href = "#/p5/random">random()</a> is used, so the result
 * will be affected by <a href = "#/p5/randomSeed">randomSeed()</a>.
 *
