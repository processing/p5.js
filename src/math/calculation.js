...
define(function (require) {
   ...
   * @return {Number} val rounded down number
   */
   ...
   * @return {Number} val lerped value
   */
   ...
   * @return {Number} val natural logarithm of n
   */
   ...
   * @return {Number} val magnitude of vector from (0,0) to (a,b)
   */
   ...
   * @return {Number} val remapped number
   * @example
<div><code>
...
function draw() {
   ...
   * @return {Number} val maximum Number
   */
   ...
   * @method min()
   * @param {Number|Array} n0 Numbers to compare
   * @return {Number} val minimum Number
   */
   ...
   * @return {Number} result normalized number
   */
   ...
   * @return {Number} val rounded number
   */
   ...
   * @return {Number} val squared number
   */
   ...
   * @return {Number} val square root of number
   */
