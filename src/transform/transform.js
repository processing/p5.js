...
define(function (require) {
  ...
  /**
   * Multiplies the current matrix by the one specified through the parameters. This is very slow because it will try to calculate the inverse of the transform, so avoid it whenever possible.
   *
   * @method applyMatrix
   ...
   *
   * @method rotate
   * @param {Number} angle the angle of rotation, specified in radians or degrees, depending on current angleMode
   * @return {p5} the p5 object
   */
   ...
   *
   * @method scale
   * @param {Number} s percentage to scale the object, or percentage to scale the object in the x-axis if multiple arguments are given
   ...
   *
   * @method shearX
   * @param {Number} angle angle of shear specified in radians or degrees, depending on current angleMode
   * @return {p5} the p5 object
   */
