 ...
 * </ul>
 *
 * See also: <code>textWidth()</code> for tight bounding box measurement.
 *
 * @method fontWidth
 ...
 *   text(s1, 10, 40);
 *   text(s2, 10, 80);
 *   line(10, 45, 10 + w1, 45); // underline advance width
 *   line(10, 85, 10 + w2, 85); // underline advance width (includes whitespace)
 *   describe('Shows difference in measured width for text with and without leading/trailing spaces using fontWidth.');
 * }
 * </code>
 * </div>
 *
 ...
 *   let s = ' ';
 *   let w = fontWidth(s);
 *   text('[' + s + ']', 10, 60); // visualize the space
 *   line(10, 65, 10 + w, 65); // advance width for a space is nonzero
 *   describe('Shows that fontWidth for a single space is nonzero, even though textWidth may be 0.');
 * }
 * </code>
 * </div>
 */
 ...
 * </ul>
 *
 * See also: <code>fontWidth()</code> for advance width measurement.
 *
 * @method textWidth
 * @param {String} str string of text to measure.
 * @return {Number} width measured in units of pixels.
 ...
 *   text(s1, 10, 40);
 *   text(s2, 10, 80);
 *   line(10, 45, 10 + w1, 45); // underline tight bounding box
 *   line(10, 85, 10 + w2, 85); // underline tight bounding box (ignores leading/trailing spaces)
 *   describe('Shows difference in measured width for text with and without leading/trailing spaces.');
 * }
 * </code>
 * </div>
 *
 ...
 *   let w = textWidth(s);
 *   text('[' + s + ']', 10, 60); // visualize the space
 *   line(10, 65, 10 + w, 65); // may be 0 for bounding box
 *   describe('Shows that textWidth for a single space may be 0, even though the space is visible.');
 * }
 * </code>
 * </div>
 */
