...
p5.prototype.createGif = function(...args) {
  ...
  /*
  Natural behaviour for me is wait for nDelay seconds 
  and then process the next nFrame seconds. Right now this
  waits nDelay seconds but processess nFrames - nDelay seconds.
  */
  var count = nFramesDelay;
  this.frameCount = count;
  //   var pImg = new p5.Image(this.width, this.height);
  var frameBuffer = [];
  noLoop();
