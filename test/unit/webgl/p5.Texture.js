suite('p5.Texture', function() {
  ...
  var testTextureSet = function(src) {
    assert(myp5._renderer.curFillShader === myp5._renderer._getLightShader(),
    ...
    assert(tex instanceof p5.Texture,
      'texture was not a p5.Texture object');
    assert(tex.src === src, 'texture did not have expected image as ' +
      'source');
  };
