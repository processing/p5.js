...
visualSuite("Typography", function () {
  visualSuite("V1", function () {
    ...
    visualSuite("Text alignment and Bounding Box", function () {
    ...
    visualSuite("Text Style", function () {
      visualTest("Text Styles Comparison", function (p5, screenshot) {
    ...
    visualSuite("Text Size", function () {
      const units = ["px"];
    ...
    visualSuite("Text Leading", function () {
      visualTest(
    ...
    visualSuite("Text Width", function () {
      visualTest("Verify didth of a string", function (p5, screenshot) {
        p5.createCanvas(300, 100);
        p5.textSize(20);
