(function(exports) {
  ...
  exports.background = function(v1, v2, v3) { 
    ...
    if (pColorMode == HSB) c = hsv2rgb(c[0], c[1], c[2]);
  ...
  exports.fill = function(v1, v2, v3, a) {
    ...
    if (pColorMode == HSB) c = hsv2rgb(c[0], c[1], c[2]);
    if (typeof a !== 'undefined') pCurCanvas.context.fillStyle = 'rgba('+c[0]+','+c[1]+','+c[2]+','+(parseInt(a, 10)/255.0)+')';
  ...
  exports.stroke = function(v1, v2, v3, a) { 
    ...
    if (pColorMode == HSB) c = hsv2rgb(c[0], c[1], c[2]);
    if (typeof a !== 'undefined') pCurCanvas.context.strokeStyle = 'rgba('+c[0]+','+c[1]+','+c[2]+','+(parseInt(a, 10)/255.0)+')';
  ...
  exports.createGraphics = function(w, h, def) {
  ...
  function pCreate() {
    ...
    pUpdateInterval = setInterval(pUpdate, 1000/frameRate);
    exports.createGraphics(800, 600);
    pDraw();
  }
