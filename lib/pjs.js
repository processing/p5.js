(function(exports) {
  ...
  function pSetupInput() {
    ...
    document.body.onmousedown = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var sk = pSketches[i];
        if (typeof sk.mousePressed === 'function')
          sk.mousePressed(e);
      } 
    }
    document.body.onmouseup = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var sk = pSketches[i];
        if (typeof sk.mouseReleased === 'function')
          sk.mouseReleased(e);
      }        
    }
    document.body.onmouseclick = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var sk = pSketches[i];
        if (typeof sk.mouseClicked === 'function')
          sk.mouseClicked(e);
      }
    }
    document.body.onmousewheel = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var sk = pSketches[i];
        if (typeof sk.mouseWheel === 'function')
          sk.mouseWheel(e);
      }     
    }
    document.body.onkeydown = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var sk = pSketches[i];
        if (typeof sk.keyPressed === 'function')
          sk.keyPressed(e);
      }
    }
    document.body.onkeyup = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var sk = pSketches[i];
        if (typeof sk.keyReleased === 'function')
          sk.keyReleased(e);
      }  
    }
    document.body.onkeypress = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var sk = pSketches[i];
        if (typeof sk.keyTyped === 'function')
          sk.keyTyped(e);
      }        
    }
  ...
  */
  ...
  var pSketches = [];  
  exports.sketch = function(sk) {
    pSketches[pSketches.length] = sk;
    if (typeof sk.setup === 'function') {
      sk.setup();
