(function(exports) {
  ...
  exports.background = function(v1, v2, v3) { 
    var c = processColorArgs(v1, v2, v3);
    // save out the fill
  ...
  exports.fill = function(v1, v2, v3, a) {
    var c = processColorArgs(v1, v2, v3, a);
    if (typeof c[3] !== 'undefined') {
      pCurCanvas.context.fillStyle = 'rgba('+c[0]+','+c[1]+','+c[2]+','+(parseInt(c[3], 10)/255.0)+')';
    } else {
      pCurCanvas.context.fillStyle = 'rgb('+c[0]+','+c[1]+','+c[2]+')';
    }
  }
  ...
  exports.stroke = function(v1, v2, v3, a) {
    var c = processColorArgs(v1, v2, v3, a);
    if (typeof c[3] !== 'undefined') {
      pCurCanvas.context.strokeStyle = 'rgba('+c[0]+','+c[1]+','+c[2]+','+(parseInt(c[3], 10)/255.0)+')';
    } else {
      pCurCanvas.context.strokeStyle = 'rgb('+c[0]+','+c[1]+','+c[2]+')';
    }
  }

  function processColorArgs(v1, v2, v3, a) {
    var c = [];
    if (typeof v2 === 'undefined' || typeof v3 === 'undefined') { 
      if (typeof v1 === 'object') {
        if (v1.length == 2) {
          // ([gray, alpha]) => [gray, gray, gray, alpha]
          c = [v1[0], v1[0], v1[0], v1[1]];
        } else {
          // ([r, g, b, alpha]) => [r, g, b, alpha]
          c = [v1[0], v1[1], v1[2], v1[3]];
        }
      } else {
        // (gray, alpha) => [gray, gray, gray, alpha]
        c = [v1, v1, v1, v2];
  ...
  exports.createImage = function(src, alt) {
