(function(exports) {
  ...
  */
  exports.text = function() {
    pCurCanvas.context.font=pTextStyle+' '+pTextSize+'px '+pTextFont;
    if (arguments.length == 3) {
  ...
  PVector.prototype.dist = function () {
    //TODO:
  }
  ...
  PVector.prototype.limit = function () {
    //TODO:
  }

  PVector.prototype.setMag = function () {
    //TODO:
  }
  ...
  PVector.prototype.rotate2D = function () {
    //TODO:
  }
  ...
  PVector.prototype.angleBetween = function () {
    //TODO:
  }
  ...
  PElement.prototype.size = function(w, h) {
    ...
    if (aW != AUTO || aH != AUTO) {
      ...
      this.width = this.elt.width;
      this.height = this.elt.height;
      if (pCurCanvas.elt == this.elt) {
        width = parseInt(this.elt.getAttribute('width'), 10);
        height = parseInt(this.elt.getAttribute('height'), 10);
      }
    }
  };
  ...
  exports.get = function(e) {
    ...
    if (res) return new PElement(res, res.offsetWidth, res.offsetHeight);
    else {
