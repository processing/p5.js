...
amdclean['p5Graphics2D'] = function (require, core, constants, p5Graphics) {
  var p5 = core;
  var constants = constants;
...
}({}, amdclean['core'], amdclean['constants'], amdclean['p5Graphics']);
...
amdclean['renderingrendering'] = function (require, core, constants) {
  ...
  p5.prototype.createCanvas = function (w, h, renderer) {
    var isDefault, c, r;
    if (arguments[3]) {
      isDefault = typeof arguments[3] === 'boolean' ? arguments[3] : undefined;
    }
