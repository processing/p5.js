...
var image = function (require, core, canvas, constants, filters) {
        ...
        p5.prototype.image = function (image, x, y, width, height) {
            ...
            var vals = canvas.modeAdjust(x, y, width, height, this.imageMode);
            if (this.tint) {
        ...
        p5.prototype._getTintedImageCanvas = function (image) {
            ...
            for (var i = 0; i < pixels.length; i += 4) {
                ...
                var b = pixels[i + 2];
                var a = pixels[i + 3];
                newPixels[i] = r * this.tint[0] / 255;
                newPixels[i + 1] = g * this.tint[1] / 255;
                newPixels[i + 2] = b * this.tint[2] / 255;
                newPixels[i + 3] = a * this.tint[3] / 255;
            }
...
var shape2d_primitives = function (require, core, canvas, constants) {
        ...
        p5.prototype.arc = function (x, y, width, height, start, stop, mode) {
            var vals = canvas.arcModeAdjust(x, y, width, height, this.ellipseMode);
        ...
        p5.prototype.ellipse = function (x, y, width, height) {
            var vals = canvas.modeAdjust(x, y, width, height, this.ellipseMode);
...
var structure = function (require, core) {
        ...
        p5.prototype.popStyle = function () {
            ...
            this.tint = lastS.tint;
            this.imageMode = lastS.imageMode;
            this.rectMode = lastS.rectMode;
            this.ellipseMode = lastS.ellipseMode;
...
var typographyloading_displaying = function (require, core, canvas) {
        ...
        p5.prototype.text = function () {
            ...
            if (arguments.length === 3) {
                ...
                var line = '';
                var vals = canvas.modeAdjust(arguments[1], arguments[2], arguments[3], arguments[4], this.rectMode);
