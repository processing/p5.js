...
amdclean['typography_p5Font'] = function (require, core_core, core_constants) {
  ...
  p5.Font.prototype._getPath = function (line, x, y, options) {
    var p = this.parent, ctx = p._graphics.drawingContext, pos = this._handleAlignment(p, ctx, line, x, y);
  ...
  p5.Font.prototype.textBounds = function (str, x, y, fontSize, options) {
    ...
    if (!result) {
      if (str !== ' ') {
        var xCoords = [], yCoords = [], scale = this._scale(fontSize), minX, minY, maxX, maxY;
  ...
  p5.Font.prototype._handleAlignment = function (p, ctx, line, x, y) {
    var textWidth = this._textWidth(line), textAscent = this._textAscent(), textDescent = this._textDescent(), textHeight = textAscent + textDescent;
...
amdclean['core_p5Graphics'] = function (require, core_core, core_constants) {
  var p5 = core_core;
  var constants = core_constants;
...
amdclean['core_error_helpers'] = function (require, core_core) {
  ...
  function report(message, func, color) {
    ...
    if (func.substring(0, 4) === 'load') {
      console.log('%c> p5.js says: ' + message + '%c' + '[https://github.com/processing/p5.js/wiki/Local-server]', 'background-color:' + color + ';color:#FFF;', 'background-color:transparent;color:' + color + ';', 'background-color:' + color + ';color:#FFF;', 'background-color:transparent;color:' + color + ';');
    } else {
  ...
  p5._friendlyFileLoadError = function (errorType, filePath) {
    ...
    var message = 'It looks like there was a problem' + ' loading your ' + errorInfo.fileType + '.' + ' Try checking if the file path%c [' + filePath + '] %cis correct,' + (errorInfo.message || '') + ' or running a local server.';
...
amdclean['io_files'] = function (require, core_core, reqwest, core_error_helpers) {
  'use strict';
  var p5 = core_core;
  var reqwest = reqwest;
  ...
  return p5;
}({}, amdclean['core_core'], amdclean['reqwest'], amdclean['core_error_helpers']);
...
amdclean['_3d_p5Matrix'] = function (require, core_core, math_polargeometry, core_constants) {
  ...
  p5.Matrix.prototype.invert = function (a) {
    ...
    var b00 = a00 * a11 - a01 * a10, b01 = a00 * a12 - a02 * a10, b02 = a00 * a13 - a03 * a10, b03 = a01 * a12 - a02 * a11, b04 = a01 * a13 - a03 * a11, b05 = a02 * a13 - a03 * a12, b06 = a20 * a31 - a21 * a30, b07 = a20 * a32 - a22 * a30, b08 = a20 * a33 - a23 * a30, b09 = a21 * a32 - a22 * a31, b10 = a21 * a33 - a23 * a31, b11 = a22 * a33 - a23 * a32, det = b00 * b11 - b01 * b10 + b02 * b09 + b03 * b08 - b04 * b07 + b05 * b06;
    if (!det) {
      return null;
    }
    det = 1 / det;
...
amdclean['_3d_p5Renderer3D'] = function (require, core_core, core_p5Renderer, _3d_p5Matrix, _3d_shaders) {
  var p5 = core_core;
  var shaders = _3d_shaders;
  var gl;
  var uMVMatrixStack = [];
  var shaderStack = [];
  window.shaderStack = shaderStack;
  var attributes = {
      alpha: false,
      depth: true,
      stencil: true,
  ...
  p5.Renderer3D.prototype.initHash = function () {
    ...
    window.materialHash = this.materialHash;
  };
  ...
  p5.Renderer3D.prototype.initBuffer = function (uuid, obj, mId) {
    ...
    gl.vertexAttribPointer(this.hash[uuid].shaderProgram.vertexPositionAttribute, 3, gl.FLOAT, false, 0, 0);
    ...
    gl.vertexAttribPointer(this.hash[uuid].shaderProgram.vertexNormalAttribute, 3, gl.FLOAT, false, 0, 0);
  ...
  p5.Renderer3D.prototype.setMatrixUniforms = function (uuid) {
    ...
    gl.uniformMatrix4fv(this.hash[uuid].shaderProgram.uPMatrixUniform, false, this.uPMatrix.mat4);
    gl.uniformMatrix4fv(this.hash[uuid].shaderProgram.uMVMatrixUniform, false, this.uMVMatrix.mat4);
    this.uNMatrix = new p5.Matrix();
    this.uNMatrix.invert(this.uMVMatrix);
    this.uNMatrix.transpose(this.uNMatrix);
    gl.uniformMatrix4fv(this.hash[uuid].shaderProgram.uNMatrixUniform, false, this.uNMatrix.mat4);
  };
...
}({}, amdclean['core_core'], amdclean['core_p5Renderer'], amdclean['_3d_p5Matrix'], amdclean['_3d_shaders']);
amdclean['core_rendering'] = function (require, core_core, core_constants, core_p5Graphics, core_p5Renderer2D, _3d_p5Renderer3D) {
  var p5 = core_core;
  var constants = core_constants;
  ...
  return p5;
}({}, amdclean['core_core'], amdclean['core_constants'], amdclean['core_p5Graphics'], amdclean['core_p5Renderer2D'], amdclean['_3d_p5Renderer3D']);
...
amdclean['_3d_3d_primitives'] = function (require, core_core, _3d_p5Geometry3D) {
  ...
  p5.prototype.cylinder = function (radius, height, detailX, detailY) {
    ...
    if (!this._graphics.geoInHash(uuid)) {
      ...
      geometry3d.parametricGeometry(createTop, detailX, 1, geometry3d.vertices.length);
      ...
      geometry3d.parametricGeometry(createBottom, detailX, 1, geometry3d.vertices.length);
...
amdclean['_3d_material'] = function (require, core_core) {
  'use strict';
  var p5 = core_core;
