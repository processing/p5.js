...
amdclean['_3d_p5Matrix'] = function (require, core_core, math_polargeometry, core_constants, _3d_Mat4) {
  'use strict';
  var p5 = core_core;
  var polarGeometry = math_polargeometry;
  var constants = core_constants;
  ...
  p5.Matrix = function () {
    if (arguments[0] instanceof p5) {
      this.p5 = arguments[0];
      this.mat4 = arguments[1] || Mat4.create();
    } else {
      this.mat4 = arguments[0] || Mat4.create();
    }
  };
  ...
  return p5.Matrix;
}({}, amdclean['core_core'], amdclean['math_polargeometry'], amdclean['core_constants'], amdclean['_3d_Mat4']);
