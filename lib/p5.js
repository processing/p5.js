...
amdclean['p5Font'] = function (require, core) {
  ...
  p5.Font.isOpenType = function (f) {
    var ok = typeof f === 'object' && f.supported;
    if (0 && !ok) {
...
amdclean['typographyattributes'] = function (require, core, constants) {
  ...
  p5.prototype.textBounds = function (str, x, y, fontSize) {
    ...
    x = x !== undefined ? x : 0;
    y = y !== undefined ? y : 0;
    var xCoords = [], yCoords = [], scale = 1 / this._textFont.unitsPerEm * this._textSize;
    this._textFont.forEachGlyph(str, x, y, this._textSize, {}, function (glyph, gX, gY, gFontSize) {
      if (glyph.name !== 'space') {
