...
amdclean['_3d_p5Graphics3D'] = function (require, core_core, _3d_shaders, core_p5Graphics, _3d_p5Matrix) {
  ...
  p5.Graphics3D.prototype.initShaders = function () {
    ...
    shaderProgram.pMatrixUniform = gl.getUniformLocation(shaderProgram, 'transformMatrix');
    shaderProgram.mvMatrixUniform = gl.getUniformLocation(shaderProgram, 'modelviewMatrix');
    shaderProgram.uMaterialColorLoc = gl.getUniformLocation(shaderProgram, 'color');
