...
amdclean['shape2d_primitives'] = function (require, core, constants, helpers) {
  ...
  p5.prototype.ellipse = function (x, y, w, h) {
    this._checkParameterExists(x, 'You need to specify a x position for ' + 'ellipses: ellipse(x, y, width, height) ' + '[http://p5js.org/reference/#p5/ellipse]');
    this._checkParameterExists(y, 'You need to specify a y position for ' + 'ellipses: ellipse(x, y, width, height)' + '[http://p5js.org/reference/#p5/ellipse]');
    this._checkParameterExists(w, 'You need to specify a width for ellipses:' + ' ellipse(x, y, width, height)' + '[http://p5js.org/reference/#p5/ellipse]');
    this._checkParameterExists(h, 'You need to specify a height for ellipses:' + ' ellipse(x, y, width, height)' + '[http://p5js.org/reference/#p5/ellipse]');
    if (!this._doStroke && !this._doFill) {
      return this;
    }
    w = Math.abs(w);
