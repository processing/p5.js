...
amdclean['helpers'] = function (require, core) {
  ...
  function report(message, func, color) {
    ...
    if (func.substring(0, 4) === 'load') {
      console.log('%c> p5.js says: ' + message + '%c []', 'background-color:' + color + ';color:#FFF;', 'background-color:transparent;color:' + color + ';', 'background-color:' + color + ';color:#FFF;', 'background-color:transparent;color:' + color + ';');
    } else {
...
amdclean['imageloading_displaying'] = function (require, core, filters, canvas, constants, helpers) {
  ...
  p5.prototype.loadImage = function (path, successCallback, failureCallback) {
    ...
    img.onerror = function (e) {
      tempThis._friendlyFileLoadError(0, img.src);
