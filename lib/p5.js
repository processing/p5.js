...
amdclean['_3d_p5Renderer3D'] = function (require, core_core, core_p5Renderer, _3d_p5Matrix, _3d_shaders) {
  ...
  p5.Renderer3D.prototype.initHash = function () {
    this.gHash = {};
    this.mHash = {};
    window.gHash = this.gHash;
    window.mHash = this.mHash;
  };
  ...
  p5.Renderer3D.prototype.drawBuffer = function (gId) {
    ...
    gl.drawElements(gl.TRIANGLES, this.gHash[gId].len, gl.UNSIGNED_SHORT, 0);
  };
  p5.Renderer3D.prototype.setMatrixUniforms = function (shaderKey) {
    ...
    gl.uniformMatrix4fv(shaderProgram.uNMatrixUniform, false, this.uNMatrix.mat4);
  };
  ...
  p5.Renderer3D.prototype.navigate = function () {
