...
var p5Graphics = function (require, core, constants) {
    ...
    p5.Graphics = function (renderer, elt, pInst) {
      ...
      if (renderer === constants.P2D) {
        ...
        this.drawingContext = this.canvas.getContext('webgl') || this.canvas.getContext('experimental-webgl');
      }
      if (this._pInst) {
...
var p5Graphics2D = function (require, core, canvas, constants, filters) {
    ...
    p5.Graphics2D.prototype.arc = function (x, y, w, h, start, stop, mode) {
      ...
      var radius = vals.h > vals.w ? vals.h * 0.5 : vals.w * 0.5, xScale = vals.h > vals.w ? vals.w / vals.h : 1, yScale = vals.h > vals.w ? 1 : vals.h / vals.w;
...
var p5Graphics3D = function (require, core, constants) {
    var p5 = core;
    var constants = constants;
...
var shape2d_primitives = function (require, core) {
    'use strict';
    var p5 = core;
