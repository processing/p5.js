...
amdclean['p5Font'] = function (require, core, constants) {
  ...
  p5.Font.prototype.renderPath = function (line, x, y, fontSize, options) {
    ...
    path.stroke = p._doStroke && (p.drawingContext.strokeStyle || constants._DEFAULT_TEXT_STROKE);
    path.fill = p._doFill && (p.drawingContext.fillStyle || constants._DEFAULT_TEXT_FILL);
...
amdclean['shapevertex'] = function (require, core, constants) {
  ...
  p5.prototype.vertex = function (x, y, moveTo) {
    ...
    vert[3] = 0;
    vert[4] = 0;
    vert[5] = this.drawingContext.fillStyle || p5.Constants._DEFAULT_TEXT_FILL;
    vert[6] = this.drawingContext.strokeStyle || p5.Constants._DEFAULT_TEXT_STROKE;
    if (moveTo) {
      vert.moveTo = moveTo;
    }
    if (isContour) {
...
amdclean['src_app'] = function (require, core, p5Color, p5Element, p5Graphics, p5Image, p5File, p5Font, p5Vector, p5TableRow, p5Table, colorcreating_reading, colorsetting, constants, dataconversion, dataarray_functions, datastring_functions, environment, imageimage, imageloading_displaying, imagepixels, inputfiles, inputkeyboard, inputacceleration, inputmouse, inputtime_date, inputtouch, mathmath, mathcalculation, mathrandom, mathnoise, mathtrigonometry, outputfiles, outputimage, outputtext_area, renderingrendering, shape2d_primitives, shapeattributes, shapecurves, shapevertex, structure, transform, typographyattributes, typographyloading_displaying) {
  'use strict';
  var p5 = core;
