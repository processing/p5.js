...
amdclean['helpers'] = function (require, core) {
  ...
  p5.prototype._checkParameterIsNumeric = function (param, func, order) {
    if (!isNumeric(param)) {
      report(func + ' was expecting a number, received "' + param + '" (parameter #' + order + ')');
    }
  };
  return p5;
}({}, amdclean['core']);
amdclean['shape2d_primitives'] = function (require, core, constants, helpers) {
  ...
  p5.prototype.ellipse = function (x, y, w, h) {
    this._checkParameterExists(x, 'You need to provide 4 numbers to create ' + 'ellipses: ellipse(x, y, width, height) ' + '[http://p5js.org/reference/#p5/ellipse]');
    this._checkParameterIsNumeric(x, 'ellipse', 1);
    this._checkParameterExists(y, 'You need to specify a y position and size ' + 'for ellipses: ellipse(x, y, width, height)' + '[http://p5js.org/reference/#p5/ellipse]');
    this._checkParameterIsNumeric(y, 'ellipse', 2);
    this._checkParameterExists(w, 'You need to provide two numbers for the ' + 'size of your ellipse: ' + ' ellipse(x, y, width, height)' + '[http://p5js.org/reference/#p5/ellipse]');
    this._checkParameterIsNumeric(w, 'ellipse', 3);
    this._checkParameterExists(h, 'You need to specify a height for ellipses.' + ' If you want a perfect circe, make this number the same as width. ' + ' ellipse(x, y, width, height)' + '[http://p5js.org/reference/#p5/ellipse]');
