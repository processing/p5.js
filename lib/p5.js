/*! p5.js v0.3.11 November 19, 2014 */
...
var imageloading_displaying = function (require, core, filters, canvas, constants) {
    ...
    p5.prototype.image = function (img, x, y, width, height) {
      ...
      if (typeof img === 'string') {
        _this.loadImage(img, function (_img) {
          _image(_img, x, y, width, height);
        });
      } else {
        _image(img, x, y, width, height);
      }
      function _image(img, x, y, width, height) {
        ...
        var vals = canvas.modeAdjust(x, y, width, height, _this._imageMode);
        if (_this._tint && img.canvas) {
          _this.drawingContext.drawImage(_this._getTintedImageCanvas(img), vals.x, vals.y, vals.w, vals.h);
        } else {
          _this.drawingContext.drawImage(frame, vals.x, vals.y, vals.w, vals.h);
        }
      }
    };
