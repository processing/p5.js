...
amdclean['helpers'] = function (require, core) {
  ...
  p5._friendlyFileLoadError = function (errorType, filePath) {
    switch (errorType) {
    case 0:
      var reportMsg0 = 'It looks like there was a problem' + ' loading your image.' + ' Try checking if the file path%c [' + filePath + '] %cis correct,' + ' hosting the image online, or running a local server.';
      report(reportMsg0, 'loadImage', FILE_LOAD);
      break;
    case 1:
      var reportMsg1 = 'It looks like there was a problem' + ' loading your XML file.' + ' Try checking if the file path%c [' + filePath + '] %cis correct,' + ' or running a local server.';
      report(reportMsg1, 'loadXML', FILE_LOAD);
      break;
    case 2:
      var reportMsg2 = 'It looks like there was a problem' + ' loading your table file.' + ' Try checking if the file path%c [' + filePath + '] %cis correct,' + ' or running a local server.';
      report(reportMsg2, 'loadTable', FILE_LOAD);
      break;
    case 3:
      var reportMsg3 = 'It looks like there was a problem' + ' loading your text file.' + ' Try checking if the file path%c [' + filePath + '] %cis correct,' + ' or running a local server.';
...
amdclean['inputfiles'] = function (require, core, reqwest, helpers) {
  'use strict';
  var p5 = core;
  var reqwest = reqwest;
  ...
  return p5;
}({}, amdclean['core'], amdclean['reqwest'], amdclean['helpers']);
