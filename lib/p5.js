...
var imageloading_displaying = function (require, core, filters, canvas, constants) {
        ...
        p5.prototype.image = function (img, x, y, width, height) {
            ...
            if (this._tint) {
                this._curElement.context.drawImage(this._getTintedImageCanvas(img), vals.x, vals.y, vals.w, vals.h);
            } else {
                this._curElement.context.drawImage(img.canvas, vals.x, vals.y, vals.w, vals.h);
            }
        };
...
var src_app = function (require, core, p5Element, p5Image, p5Vector, colorcreating_reading, colorsetting, constants, dataarray_functions, datastring_functions, dommanipulate, environment, imageimage, imageloading_displaying, imagepixels, inputfiles, inputkeyboard, inputmouse, inputtime_date, inputtouch, mathmath, mathcalculation, mathrandom, mathnoise, mathtrigonometry, outputfiles, outputimage, outputtext_area, shape2d_primitives, shapeattributes, shapecurves, shapevertex, structure, transform, typographyattributes, typographyloading_displaying) {
        'use strict';
        var p5 = core;
