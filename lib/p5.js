...
amdclean['core_p5Graphics'] = function (require, core_core) {
  ...
  p5.Graphics = function (elt, pInst, isMainCanvas) {
    ...
    if (isMainCanvas) {
      ...
      // this._pInst = this;
      // this._pInst.pixelDensity = pInst.pixelDensity;
  ...
  p5.GraphicsHolder = function (elt, pInst, isMainCanvas) {
    p5.Element.call(this, elt, pInst);
    this.canvas = elt;
  ...
  p5.GraphicsHolder.prototype = Object.create(p5.Element.prototype);
...
amdclean['core_rendering'] = function (require, core_core, core_constants, core_p5Graphics2D, _3d_p5Graphics3D) {
  ...
  p5.prototype._createGraphics2D = function (w, h) {
    ...
    var node = this._userNode || document.body;
    node.appendChild(c);
    var pg = new p5.GraphicsHolder(c, this, false);
    pg.width = w;
    pg.height = h;
    pg.pixelDensity = this.pixelDensity;

    var g = new p5.Graphics2D(c, pg, false);
