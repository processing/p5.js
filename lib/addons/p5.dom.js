...
var p5DOM = (function(){
  ...
  p5.prototype.createVideo = function(src1, src2) {
    ...
    c.loadPixels = function() {
      if (!c.canvas) {
        ...
        c.canvas.getContext('2d').drawImage(c.elt, 0, 0);
    ...
    c.updatePixels =  function(x, y, w, h){
      p5.prototype.updatePixels.call(c, x, y, w, h);
    }
    c.get = function(x, y, w, h){
      return p5.prototype.get.call(this, x, y, w, h);
    };
    c.set = function(x, y, imgOrCol){
      p5.prototype.set.call(c, x, y, imgOrCol);
    };
    return c;  
  };
   ...
   *                           node
   */
  p5.prototype.create = function(tag, content) {
    var elt = document.createElement(tag);
