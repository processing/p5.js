...
// =============================================================================
  ...
  /**
   * Translates an element relative to (0, 0) of the window through
   * css transforms. 
   * @method  translate
   * @param  {Number} x x-position relative to upper left of window
   * @param  {Number} y y-position relative to upper left of window
   ...
   * </code></div>
   */
  p5.Element.prototype.translate = function(x, y){
    this.elt.style.position = 'absolute';
    this.elt.style.transform = 'translateX('+x+'px)';
    this.elt.style.transform += 'translateY('+y+'px)';
    return this;
  };
