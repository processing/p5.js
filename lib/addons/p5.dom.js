...
// =============================================================================
   ...
   *  the callback.
   *
   *  The time will be passed to the callback function.
   *
   *
   *  @method  setTimeline
   *  @param {Function} callback name of a function that will be called at
   *  the given time.
   *  @param {Number}   time     Time in seconds,
   *                             i.e. 3.051 is three seconds + 0.051
   ...
   *    audioEl.show();
   *
   *    // schedule two calls to changeBackground
   *    audioEl.setTimeline(changeBackground, 2.02);
   *    audioEl.setTimeline(changeBackground, 4.02);
   *  }
   *
   ...
   *  </code></div>
   */
  p5.MediaElement.prototype.setTimeline = function(callback, time) {
    var id = this._timelineEventIDCounter++;

    var timeline = new TimelineEvent(callback, time, id);
  ...
  p5.MediaElement.prototype._onTimeUpdate = function() {
    ...
    for (var i = 0 ; i < this._timelineEvents.length; i++) {
      ...
      if (this._prevTime < callbackTime && callbackTime <= playbackTime) {
        ...
        this._timelineEvents[i].callback(callbackTime);
      }
  ...
  var TimelineEvent = function(callback, time, id) {
