...
// =============================================================================
   ...
   * @param  {String} [label] label displayed on the button
   * @param  {boolean} [value] value of the button
   * @return {Object/p5.Element} pointer to p5.Element holding created
   *                           node
   */
  p5.prototype.createCheckbox = function() {
    var elt = document.createElement('input');
    elt.type = 'checkbox';
    //checkbox must be added before label so that label appears after
    var el = addElement(elt, this);
    if (arguments.length > 0){
      var lbl = document.createElement('label');
      elt.setAttribute('id', '_id');
      lbl.htmlFor = '_id';
      lbl.appendChild(document.createTextNode(arguments[0]));
      addElement(lbl, this);
    }
