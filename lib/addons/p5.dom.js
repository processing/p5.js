...
// =============================================================================
   ...
   *   ele = createAudio('assets/beat.mp3');
   *   setMessageAndBackground("Click to play!", 200);
   * }
   *
   * function mouseClicked() {
   *   //here we test if the mouse is over the
   ...
   *       setMessageAndBackground("Click to stop!", 200);
   *     }
   *   }
   * }
   *
   * //simply set the message and background shade of grey
   * //on the canvas. Included to make the example
   * //above more readable.
