...
var p5DOM = (function(){
  ...
  /**
   * Creates a hidden HTML5 <audio> element in the DOM for simple
   * audio playback. Appends to the container node if one is specified, 
  ...
  p5.prototype.createAudio = function(src) {
