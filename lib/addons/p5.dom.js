...
// =============================================================================
  ...
  /**
   * Creates an &lt;input&gt;&lt;/input&gt; element in the DOM for files.
   * 
   * @method createInput
   * @param  {Number} [value] default text for the button
   * @return {Object/p5.Element} pointer to p5.Element holding created
   *                           node
   */
  p5.prototype.createFileInput = function(multiple, callback) {
...
// =============================================================================
//                         p5.FileInputElement additions
// =============================================================================


  /**
   * Extends p5.Element to handle files selected by user. In addition to the methods
   * of p5.Element, it also contains methods for reading those files. It is not
   * called directly, but p5.FileInputElement are created by calling createFileInput,
   * and more to come?

   * @class p5.FileInputElement
   * @constructor
   * @param {String} elt DOM node that is wrapped
   * @param {Object} [pInst] pointer to p5 instance
   */
  ...
  p5.FileInputElement = function(elt, pInst) {
    p5.Element.call(this, elt, pInst);
  };
  p5.FileInputElement.prototype = Object.create(p5.Element.prototype);
