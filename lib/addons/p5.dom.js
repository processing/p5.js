...
// =============================================================================
   ...
   *   cnv.stylePosition(50, 100);
   * }
   * </code></div>
   */
  p5.Element.prototype.stylePosition = function() {
    if (arguments.length === 0){
   ...
   *   select('canvas').styleTranslate(0,50);
   * }
   * </code></div>
   */
  p5.Element.prototype.styleTranslate = function(){
    this.elt.style.position = 'absolute';
   ...
   *   select('canvas').styleRotate(x,y,z);
   * }
   * </code></div>
   */
  p5.Element.prototype.styleRotate = function(){
    if (arguments.length === 1){
