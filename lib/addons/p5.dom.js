...
var p5DOM = (function(){
   ...
   * @param  {String} [src]     path to a video file in a different format (optional, to ensure compatability)
   ...
   * @param  {String} [src]        path to an audio file in different format (optional, to ensure compatability)
