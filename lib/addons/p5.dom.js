...
// =============================================================================
  ...
  p5.Element.prototype.translate = function(){
    ...
    if (arguments.length === 2){
      var style = this.elt.style.transform.replace(/translate3d\(-?\d+[a-zA-Z%]+, ?-?\d+[a-zA-Z%]+, ?-?\d+[a-zA-Z%]+\)/g, '');
      style = style.replace(/translate[X-Z]?\(-?\d+[a-zA-Z%]+\)/g, '');
  ...
  p5.Element.prototype.rotate = function(){
    if (arguments.length === 2){
      var style = this.elt.style.transform.replace(/rotate3d\(-?\d+[a-zA-Z%]+, ?-?\d+[a-zA-Z%]+, ?-?\d+[a-zA-Z%]+,?\d*\)/g, '');
      style = style.replace(/rotate[X-Z]?\(-?\d+[a-zA-Z%]+\)/g, '');
   ...
   * @return {p5.Element}
   */
  // p5.Element.prototype.widthFn = function() {
  //   console.log('hi');
  //   if (this.elt.offsetWidth !== 'undefined'){
  //     console.log('this is the width fxn');
