...
(function (modules) {
  ...
  function (module, exports, __webpack_require__) {
    ...
    !((__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(17)]),
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (audiocontext) {
  ...
  function (module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
      ...
      return (
        ...
        (o.TimelineSignal.prototype.setValueCurveAtTime = function (
          e,
          t,
          i,
          n
    ...
    !((__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
      ...
      p5.PolySynth.prototype.noteAttack = function (
        ...
        if (this._voicesInUse.getValueAtTime(acTime) < this.maxVoices) {
          currentVoice = Math.max(
            ~~this._voicesInUse.getValueAtTime(acTime),
            0
          );
        } else {
  ...
  function (module, exports, __webpack_require__) {
    ...
    var moduleSources = [
      ...
      __webpack_require__(38)['default'],
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (n) {
      ...
      return (
        (n.AudioToGain = function () {
          this._norm = this.input = this.output = new n.WaveShaper(function (
            n
          ) {
            return (n + 1) / 2;
          });
    ...
    !((__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
      ...
      p5.SoundLoop.prototype.syncedStart = function (otherLoop, timeFromNow) {
        ...
        if (!otherLoop.isPlaying) {
          ...
          var time =
            otherLoop.clock._nextTick - p5sound.audiocontext.currentTime;
